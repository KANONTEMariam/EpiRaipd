      ...
      setTimeout(function(){
        jQuery.getJSON('/cart.js', function(cart) {
          ...
          if(cart.item_count > 0){
            ...
            $('.items_carts span').remove();
            $('.items_carts').html("<span class='money'>0 FCFA</span>");
          }
        });
        ...
        if(cart_priceVal < shipp_price) {
          ...
          var rate_count = Shopify.formatMoney(shipping_minus , {{ shop_currency_val | money_with_currency  }});
    ...
    addtocart_form: function(form_id, callback, errorCallback){
      ...
      var ajax = {
        ...
        success: function(item){
          ...
          jQuery('#cart-upsell-popup').find('.media h6').html('<i class="fa fa-check"></i>Item <span class="cart_lang_trans" >' + _name + '</span><span> successfully added to your Cart</span>');
...
var ajaxCart = (function(module, $){
  ...
  updateCountPrice = function (cart) {
    ...
    buildCart = function(cart){
      ...
      if (cart.item_count === 0) {
        $cartContainer
        .append('<div class="empty_cart_slide_cls">' + {{ 'cart.general.empty' | t | json }} + '</div>');
        cartCallback(cart);
        return;
      }
